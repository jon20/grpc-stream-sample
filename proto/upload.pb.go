...
func (*UploadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_e94b4548a76394ea, []int{0}
}
...
type UploadReply struct {
	UploadStatus         int64    `protobuf:"varint,1,opt,name=UploadStatus,proto3" json:"UploadStatus,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*UploadReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_upload_e94b4548a76394ea, []int{1}
}
...
func (m *UploadReply) GetUploadStatus() int64 {
	if m != nil {
...
func init() { proto.RegisterFile("upload.proto", fileDescriptor_upload_e94b4548a76394ea) }

var fileDescriptor_upload_e94b4548a76394ea = []byte{
	...
	0x92, 0x58, 0x52, 0x5a, 0x0c, 0x56, 0xcf, 0x1c, 0x84, 0x22, 0x66, 0xe4, 0x09, 0xb3, 0xc1, 0x23,
	...
	0xc0, 0x6e, 0x37, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xe2, 0xe1, 0xca, 0xdd, 0xcb, 0x00, 0x00,
	0x00,
}
